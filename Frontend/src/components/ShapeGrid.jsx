...
const ShapeGrid = ({
  ...
  squareSize = 40,
  hoverFillColor = '#4F46E5', // Modern Indigo
  shape = 'square',
  hoverTrailAmount = 5
}) => {
  ...
  useEffect(() => {
    ...
    const drawGrid = () => {
      ...
      // We remove the hardcoded background fill so it can be transparent
      // and we can handle background coloring in the parent component.
    };
